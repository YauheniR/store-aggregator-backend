...
class ProductApiTestCase(UserRegistration):
    ...
    def setUp(self) -> None:
        ...
        CategoryModel.objects.bulk_create([CategoryModel(name='category 1'),
                                           CategoryModel(name='category 2'),
                                           CategoryModel(name='category 3')])
        self.category = CategoryModel.objects.get(name='category 1')

        self.data = ProductModel.objects.bulk_create([ProductModel(category=self.category),
                                                      ProductModel(category=self.category)])
    ...
    def test_get_product_call_200_ok(self):
        response = self.client.get(reverse('product_detail', args=(self.detail_data.id,)))
    ...
    def test_post_product_call_201_created(self):
        response = self.client.post(reverse('products_list'), {'category': self.category.id})
    ...
    def test_put_product_call_200_ok(self):
        ...
        response = self.client.put(reverse('product_detail', args=(self.detail_data.id,)),
    ...
    def test_patch_product_call_200_ok(self):
        ...
        response = self.client.patch(reverse('product_detail', args=(self.detail_data.id,)),
    ...
    def test_delete_product_call_204_no_content(self):
        response = self.client.delete(reverse('product_detail', args=(self.detail_data.id,)))
...
class ProviderProductApiTestCase(UserRegistration):
    ...
    def setUp(self) -> None:
        ...
        self.data = ProviderProductModel.objects.bulk_create([ProviderProductModel(name='provider product 1',
                                                                                   price=25.23,
                                                                                   code=32543465,
                                                                                   provide=provider,
                                                                                   product=product),
                                                              ProviderProductModel(name='provider product 2',
                                                                                   price=55.48,
                                                                                   code=32543345,
                                                                                   provide=provider,
                                                                                   product=product),
    ...
    def test_get_provider_products_call_200_ok(self):
        response = self.client.get(reverse('providers_product_list', args=(self.product.id,)))

        self.assertEqual(status.HTTP_200_OK, response.status_code)
        self.assertEqual(ProviderProductModel.objects.count(), len(self.data))

    def test_get_provider_product_call_200_ok(self):
        response = self.client.get(reverse('providers_product_detail', args=(self.product.id, self.detail_data.id)))
    ...
    def test_post_provider_product_call_201_created(self):
        post_provider_product = ProviderProductModel(name='tmpName',
                                                     price=235.235,
                                                     code=32526,
                                                     product=self.product,
                                                     provide=self.provide, )

        response = self.client.post(reverse('providers_product_list', args=(self.product.id,)),
    ...
    def test_put_provider_product_call_200_ok(self):
        put_provider_product = ProviderProductModel(name='New Name',
                                                    price=6457457,
                                                    code=23523464,
                                                    product=self.product,
                                                    provide=self.provide, )

        response = self.client.put(reverse('providers_product_detail', args=(self.product.id, self.detail_data.id)),
    ...
    def test_patch_provider_product_call_200_ok(self):
        patch_provider_product = ProviderProductModel(name='Patch Name',
                                                      price=684734635,
                                                      code=1241325423,
                                                      product=self.product,
                                                      provide=self.provide, )

        response = self.client.patch(reverse('providers_product_detail', args=(self.product.id, self.detail_data.id)),
    ...
    def test_delete_provider_product_call_201_no_content(self):
        response = self.client.delete(reverse('providers_product_detail', args=(self.product.id, self.detail_data.id,)))
